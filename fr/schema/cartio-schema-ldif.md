# Code LDIF du Schéma (cn=config)

Il s'agit du fichier LDIF prêt pour l'importation dynamique dans OpenLDAP (`cn=config`). Il définit les attributs et les classes d'objets de l'écosystème CARTIO :
